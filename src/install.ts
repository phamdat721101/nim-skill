...
export const PRIMITIVES = ['nim-guard', 'nim-error-handler', 'nim-monitor', 'nim-enforcer', 'nim-context', 'nim-cache', 'nim-baseline', 'nim-index', 'nim-profile', 'nim-workspace', 'nim-lessons', 'nim-workrule', 'nim-logcompact', 'nim-propose', 'nim-grill', 'nim-deliver'] as const;
