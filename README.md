...
| `nim-search` | Header-aware local BM25 recall over memory, lesson, and archive files, plus an additive AST-aware code/spec search surface (`search overview\|graph\|hydrate\|compile`). |
